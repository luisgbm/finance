...
//   * Postgres (sqlx, snake_case)   -> e.g. "expense", "transfer_income"
// The React frontend relies on the PascalCase JSON values, while the database
// enum types use snake_case. Do not collapse these into one representation.
// ---------------------------------------------------------------------------

#[derive(sqlx::Type, Debug, Serialize, Deserialize, Copy, Clone, PartialEq, Eq)]
#[sqlx(type_name = "category_types", rename_all = "snake_case")]
...
#[derive(sqlx::Type, Debug, Serialize, Deserialize, Copy, Clone, PartialEq, Eq)]
// NOTE: the Postgres type name is misspelled ("transacion") in the existing schema.
#[sqlx(type_name = "scheduled_transacion_kinds", rename_all = "snake_case")]
...
#[derive(sqlx::Type, Debug, Serialize, Deserialize, Copy, Clone, PartialEq, Eq)]
#[sqlx(type_name = "repeat_frequencies", rename_all = "snake_case")]
...
/// Internal (non-serialized) value object used to insert/update a scheduled
/// transaction row. Equivalent to the original Diesel `NewScheduledTransaction`.
#[derive(Debug, Clone)]
