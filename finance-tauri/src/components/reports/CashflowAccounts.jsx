...
const CashflowAccounts = () => {
    ...
    const selectedAccountIds = useSelector(state => state.cashflowReport.selectedAccountIds);
    ...
    const toggle = (id) => {
        ...
        dispatch({type: 'setCashflowAccounts', payload: allIds.filter(x => next.has(x))});
    };

    const selectAll = () => {
        dispatch({type: 'setCashflowAccounts', payload: [...allIds]});
    };

    const deselectAll = () => {
        dispatch({type: 'setCashflowAccounts', payload: []});
    };
