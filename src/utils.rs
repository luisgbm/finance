...
pub fn get_scheduled_transaction_to_join(get_scheduled_transaction: &GetScheduledTransaction) -> ScheduledTransactionTransferJoined {
    ScheduledTransactionTransferJoined {
        ...
        category_id: Some(get_scheduled_transaction.category_id),
        category_type: Some(get_scheduled_transaction.category_type),
        category_name: Some(get_scheduled_transaction.category_name.clone()),
